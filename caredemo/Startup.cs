...
namespace caredemo
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                // Password settings
                options.Password.RequireDigit = false;// identityDefaultOptions.;
                options.Password.RequiredLength = 4;// identityDefaultOptions.PasswordRequiredLength;
